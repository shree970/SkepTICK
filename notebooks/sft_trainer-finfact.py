...
class ScriptArguments:
    ...
    seq_length: Optional[int] = field(default=1536, metadata={"help": "Input sequence length"})
    ...
    hub_model_id: Optional[str] = field(default="mistral-7b-finetuned-finfacts", metadata={"help": "The name of the model on HF Hub"})
